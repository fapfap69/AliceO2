...
#include "HMPIDWorkflow/DigitsToClustersSpec2.h"
...
void DigitsToClustersTask2::strToFloatsSplit(std::string s,
...
//=======================
//
void DigitsToClustersTask2::init(framework::InitContext& ic)
{
  ...
  mRec.reset(new o2::hmpid::Clusterer2()); // ef: changed to smart-pointer

  mExTimer.start();
}

void DigitsToClustersTask2::run(framework::ProcessingContext& pc)
{
  // outputs
...
void DigitsToClustersTask2::endOfStream(framework::EndOfStreamContext& ec)
{
